// ==========================================================================
// Project:   CocktailsAndroid - ApplicationRootState
 ...
 * route.
 */
CocktailsAndroid.ApplicationRootState = SC.State.design({
    ...
    showCocktailAction: function(sender, context) {
        ...
        CocktailsCore.currentCocktailController.set('content', CocktailsAndroid.store.find(CocktailsCore.Cocktail, context));
    ...
    showingAllCocktailsState: SC.State.design({
        enterState: function() {
            ...
            CocktailsAndroid.mainPage.mainPane.bodyView.set('nowShowing', 'allCocktailListView');
        }
    }),
    ...
    showingPersonalCocktailsState: SC.State.design({
        enterState: function() {
            ...
            // switch out applications main body content
            CocktailsAndroid.mainPage.mainPane.bodyView.set('nowShowing', 'personalCocktailListView');

            if(CocktailsCore.personalCocktailsController.get('needsUpdate')) {
                var store = CocktailsAndroid.store;
    ...
    showingInventoryState: SC.State.design({
        enterState: function() {
            ...
            // switch out applications main body content
            CocktailsAndroid.mainPage.mainPane.bodyView.set('nowShowing', 'inventoryView');
        }
    }),
    ...
    showingHelpState: SC.State.design({
        enterState: function() {
            ...
            // switch out applications main body content
            CocktailsAndroid.mainPage.mainPane.bodyView.set('nowShowing', 'helpView');
        }
    }),

    showingCocktailState: SC.State.plugin('CocktailsAndroid.SingleCocktailState')
});