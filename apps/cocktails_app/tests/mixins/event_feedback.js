// ==========================================================================
// Project:   CocktailsApp.EventFeedback Unit Test
...
(function () {
    ...
    pane = SC.ControlTestPane.design()
        .add("simple_view", SC.View.design(CocktailsApp.EventFeedback, {}))
        .add("view_with_layout", SC.View.design(CocktailsApp.EventFeedback, {
            layout: {height: 30, width: 30}
        }));

    module("CocktailsApp.EventFeedback", {
        setup: function () {
    ...
    test("Mixing in CocktailsApp.EventFeedback causes no errors", function() {
