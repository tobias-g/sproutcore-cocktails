// ==========================================================================
// Project:   CocktailsDesktop - PrimaryNavMenuState
 ...
 * @type SC.State
 */
CocktailsDesktop.PrimaryNavMenuState = SC.State.extend({
    initialSubstate: 'hiddenMenuState',

    hiddenMenuState: SC.State.design({
        enterState: function() {
            CocktailsDesktop.mainPage.mainPane.leftNavView.set('isVisible', false);
    ...
    showingMenuState: SC.State.design({
        enterState: function() {
            CocktailsDesktop.mainPage.mainPane.leftNavView.set('isVisible', true);
