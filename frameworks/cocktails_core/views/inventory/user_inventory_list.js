// ==========================================================================
// Project:   CocktailsCore - inventory list
 ...
 * a user has.
 * @type {CocktailsCore.InventoryUserInventoryListView}
 * @extends {SC.ListView}
 */
CocktailsCore.InventoryUserInventoryListView = SC.ListView.extend({
    /**
    ...
    exampleView: SC.View.extend(SC.ContentDisplay, SC.Gesturable, CocktailsCore.EventFeedback, {
         ...
         * @type {SC.TapGesture}
         */
        inventoryItemTapGesture: CocktailsCore.TapGesture,
